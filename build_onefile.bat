...
pyinstaller --noconfirm --clean --specpath build --noconsole --onefile --name Annota --icon "%CD%\assets\annota.ico" --add-data "%CD%\assets;assets" --hidden-import ctypes --hidden-import json --hidden-import os --hidden-import platform --hidden-import tempfile --hidden-import dataclasses --hidden-import datetime --hidden-import pathlib --hidden-import typing --hidden-import PySide6.QtCore --hidden-import PySide6.QtGui --hidden-import PySide6.QtWidgets --hidden-import pynput --hidden-import winreg main.py
if errorlevel 1 goto :fail
